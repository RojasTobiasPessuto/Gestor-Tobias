...
const typeColors: Record<TransactionType, string> = {
  ...
  VENTA_DOLARES: '#f59e0b',
  COMPRA_DOLARES: '#8b5cf6',
};
  ...
  return (
    <div className="page">
      ...
      {loading ? (
        ...
        <p className="empty">No hay transacciones</p>
      ) : (
            ...
            <tbody>
              {transactions.map((tx) => (
                <tr key={tx.id}>
                  ...
                  <td>
                    <span className="badge" style={{ backgroundColor: typeColors[tx.type] }}>
                      {typeLabels[tx.type]}
                    </span>
                  </td>
                  <td className="amount">
